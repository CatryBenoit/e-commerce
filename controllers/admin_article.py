...
def show_article():
    ...
    FROM 
        cle_usb c
    JOIN 
        type_cle_usb t ON c.type_cle_usb_id = t.id_type_cle_usb;
    '''
...
def add_article():
    mycursor = get_db().cursor()
    sql = '''SELECT libelle_type_cle_usb AS libelle,id_type_cle_usb AS id_type_article FROM type_cle_usb'''
    mycursor.execute(sql)
...
def valid_add_article():
    ...
    sql = '''  INSERT INTO cle_usb(nom_cle_usb,image,prix_cle_usb,type_cle_usb_id,description,stock) 
    VALUES (%s,%s,%s,%s,%s,%s)'''
...
def edit_article():
    ...
    mycursor = get_db().cursor()
    sql = '''
    SELECT id_cle_usb AS id_article, nom_cle_usb AS nom, prix_cle_usb AS prix,image,description, type_cle_usb_id AS id_type_article, stock 
    ...
    print(article)
    sql = '''
    SELECT libelle_type_cle_usb AS libelle, id_type_cle_usb AS id_type_article FROM cle_usb
    JOIN type_cle_usb tcu on tcu.id_type_cle_usb = cle_usb.type_cle_usb_id
    WHERE id_cle_usb = %s
    '''
    mycursor.execute(sql, id_article)
...
def valid_edit_article():
    ...
    sql = '''
       SELECT image FROM cle_usb WHERE id_cle_usb = %s
       '''
    mycursor.execute(sql, id_article)
    ...
    print(nom, image_nom, prix, type_article_id, description, stock, id_article)

    sql = '''  UPDATE 
    cle_usb SET nom_cle_usb = %s, image = %s,prix_cle_usb=%s, type_cle_usb_id = %s, description = %s,stock = %s 
    WHERE id_cle_usb = %s '''
